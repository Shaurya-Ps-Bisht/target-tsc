...
function scrubIgnoredFields(actual: any, expected: any): { scrubbedActual: any; scrubbedExpected: any } {
  ...
  function traverse(actualObj: any, expectedObj: any) {
    for (const key in expectedObj) {
      ...
      } else if (typeof expectedObj[key] === 'object' && expectedObj[key] !== null && typeof actualObj[key] === 'object' && actualObj[key] !== null) {
...
test.afterAll(async () => {
  // Optional: Add cleanup logic to close connections
